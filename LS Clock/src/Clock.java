...
public class Clock
{
     ...
     * argument. The clock cannot exceed 23:59:59 and thus, while the total
     * seconds are equal to or more than 86400 (i.e. 24 hours) then the clock is
     * rewinded to the day before subtracting 86400 seconds (which makes sure that
     * the total seconds are in the interval [0-86400])
     *
     * @param totalSeconds
     *   the total seconds since midnight
     * @throws IllegalArgumentException
     ...
     * cannot exceed 23:59:59 and thus, while the total seconds are equal to or
     * more than 86400 (i.e. 24 hours) then the clock is rewinded to the day
     * before subtracting 86400 seconds (which makes sure that the total seconds
     * are in the interval [0-86400])
     *
     * @param totalSeconds
     *   the total seconds since midnight
     * @throws IllegalArgumentException
     ...
     * <br>13:12:58 will be updated to 13:12:59<br>
    ...
    /**
     * A string representation of the clock in the format HH:MM:SS. I.e. two
     * digits for hour, minute and second. Examples: "09:59:59", "10:05:01",
     * "23:59:00"
     *
